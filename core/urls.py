...
urlpatterns = [
    ...
    path('prescripciones/crear/', views.crear_prescripcion, name='crear_prescripcion'),
    path('prescripciones/editar/<int:id>/', views.editar_prescripcion, name='editar_prescripcion'),
